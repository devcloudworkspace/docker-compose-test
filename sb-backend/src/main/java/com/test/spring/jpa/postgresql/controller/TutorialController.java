...
import com.test.spring.jpa.postgresql.model.Tutorial;
import com.test.spring.jpa.postgresql.repository.TutorialRepository;
...
public class TutorialController {
	...
	public ResponseEntity<List<Tutorial>> getAllTutorials(@RequestParam(required = false) String title) {
		LOG.info("inside 'getAllTutorials'");
